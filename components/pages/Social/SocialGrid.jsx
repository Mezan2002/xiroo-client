...
function SocialCard({ post }) {
  ...
  return (
    ...
    >
      {post.isPinned && (
        <div className="absolute top-2 left-2 z-10 flex items-center gap-1 bg-yellow-400 text-yellow-900 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider">
