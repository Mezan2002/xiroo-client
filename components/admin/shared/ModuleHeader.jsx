      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 md:gap-3">
            <Link href="/admin" className="w-7 h-7 md:w-8 md:h-8 bg-zinc-50 flex items-center justify-center border border-zinc-100 hover:bg-zinc-100 transition-colors shrink-0">
