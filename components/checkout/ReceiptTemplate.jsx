          ...
          <div style={{ width: "260px" }}>
            ...
            {discount && roundedDiscount > 0 && (
              <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0" }}>
                ...
                <p style={{ fontSize: "11px", fontWeight: "700", margin: 0, color: "#2a9d4e" }}>
                  {discount.type === 'free_shipping' ? 'Free Shipping' : `-৳${roundedDiscount.toLocaleString()}`}
                </p>
              </div>
            )}
            <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0" }}>
              <p style={{ fontSize: "11px", color: "#666", margin: 0, fontWeight: "500" }}>Shipping:</p>
              <p style={{ fontSize: "11px", fontWeight: "700", margin: 0 }}>{delivery === 0 ? "Free" : `৳${delivery.toLocaleString()}`}</p>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0" }}>
