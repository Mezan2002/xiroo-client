      ...
      <div className="space-y-10 animate-pulse">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="aspect-4/5 bg-gray-50 border border-gray-100"
            />
          ))}
        </div>
      </div>
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {wishlistItems.length > 0 ? (
        ...
        <div className="py-24 text-center border border-gray-50 bg-gray-50/10 rounded-none">
          ...
          <p className="text-gray-400 text-sm font-medium uppercase tracking-widest mb-8 italic">
            Your wishlist is empty
          </p>
          <Button
            href="/collections"
            className="rounded-none px-10 h-14 tracking-widest font-bold uppercase text-[11px]"
          >
            EXPLORE BOUTIQUE
          </Button>
        </div>
