        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between p-6 hover:bg-black/5 transition-all border border-transparent hover:border-black/5 group"
              >
