...
export default function CustomerIdentityCard({ user }) {
  return (
    <Card title="Customer Identity">
      <div className="space-y-8">
        ...
        <div className="pt-6 border-t border-zinc-100 flex flex-col gap-4">
          <DetailSection label="Communication" value={user?.phoneNumber || "NO_CONTACT_DATA"} />
          <DetailSection label="Account Tier" value={user?.tier || "Standard"} />
        </div>
      </div>
    </Card>
  );
