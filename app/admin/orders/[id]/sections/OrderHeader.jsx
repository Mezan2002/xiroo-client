...
const statusStyles = {
  ...
  "given-for-design":    { dot: "bg-purple-500",  text: "text-purple-600",  bg: "bg-purple-50",  border: "border-purple-200" },
  "ready-to-pack":       { dot: "bg-amber-500",   text: "text-amber-600",   bg: "bg-amber-50",   border: "border-amber-200" },
  "packed-for-delivery": { dot: "bg-orange-500",  text: "text-orange-600",  bg: "bg-orange-50",  border: "border-orange-200" },
  shipped:               { dot: "bg-blue-500",    text: "text-blue-600",    bg: "bg-blue-50",    border: "border-blue-200" },
  "at-last-hub":         { dot: "bg-cyan-500",    text: "text-cyan-600",    bg: "bg-cyan-50",    border: "border-cyan-200" },
  "assigned-for-delivery": { dot: "bg-indigo-500", text: "text-indigo-600", bg: "bg-indigo-50",  border: "border-indigo-200" },
  ...
  "return-received":     { dot: "bg-rose-500",    text: "text-rose-600",    bg: "bg-rose-50",    border: "border-rose-200" },
...
const statusOptions = [
  ...
  { value: "packed-for-delivery",   label: "Packed for Delivery",   icon: PackageCheck },
  { value: "shipped",               label: "Shipped",               icon: Truck },
  { value: "at-last-hub",           label: "At Last Hub",           icon: MapPin },
  { value: "assigned-for-delivery", label: "Assigned for Delivery", icon: UserCheck },
